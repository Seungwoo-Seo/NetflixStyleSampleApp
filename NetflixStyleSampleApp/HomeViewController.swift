...
extension HomeViewController {
    ...
    override func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        print("Test: \(sectionName)섹션의 \(indexPath.item + 1)번째 콘텐츠")
    }
...
private extension HomeViewController {
    ...
    func attribute() {
        ...
        let resizedImage = #imageLiteral(resourceName: "netflix_icon").resized(to: CGSize(width: 44, height: 44)).withRenderingMode(.alwaysOriginal)
        
        navigationItem.leftBarButtonItem = UIBarButtonItem(image: resizedImage, style: .plain, target: nil, action: nil)
    ...
    func createRankTypeSection() -> NSCollectionLayoutSection {
        // item
